      ...
      <section className="relative py-32 bg-slate-800">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12 text-center">
            <div>
              <div className="text-6xl md:text-7xl font-light text-white mb-4">300</div>
              <div className="text-white/80 text-lg">+</div>
              <div className="text-white/90 mt-2">Clients Served</div>
            </div>
            <div>
              <div className="text-6xl md:text-7xl font-light text-white mb-4">30000</div>
              <div className="text-white/80 text-lg">+</div>
              <div className="text-white/90 mt-2">Aircraft</div>
            </div>
            <div>
              <div className="text-6xl md:text-7xl font-light text-white mb-4">10</div>
              <div className="text-white/80 text-lg">+</div>
